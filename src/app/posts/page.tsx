  ...
  return (
    <main className="min-h-screen bg-slate-950 text-slate-100 p-6 md:p-8 relative">
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        {/* Filtros e Busca */}
        <div className="p-4 rounded-xl bg-slate-900/40 border border-slate-800/80 backdrop-blur-md flex flex-col md:flex-row gap-4 items-center">
        ...
        <div className="rounded-xl border border-slate-800 bg-slate-900/20 overflow-hidden backdrop-blur-md">
          {isLoading ? (
            ...
            <div className="p-16 text-center text-slate-500 space-y-3 flex flex-col items-center justify-center">
                      ...
                      <td className="py-4 px-6">
                        <div className="flex flex-wrap gap-1 max-w-xs">
                          {post.tags && post.tags.length > 0 ? (
                            post.tags.map((tag) => (
                              <span key={tag} className="inline-flex items-center gap-1 px-2 py-0.5 rounded bg-slate-800 text-[10px] font-medium text-slate-300 border border-slate-700/50">
